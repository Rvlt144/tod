...
*/
const A187 = '💔 R E V 💔'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/revolt_144'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6283164445159'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/KBt8lh74kvUJ6gunrVkco4'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UCH1CF2_cQ-bseuB46M04_kw'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @revolt_144`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @revolt_144`)
})
...
conn.on('message-new', async(m) =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Name: [ ${pushname} ] => ${text}`);
   //GroupsA187ID
...
conn.sendMessage(id, ' _Syalom juga Sahabat Terkasih 😇 ..ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'syalom'){
conn.sendMessage(id, ' _Syalom juga Sahabat Terkasih 😇 ..ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' *Owner 💔 R E V 💔 wa.me/+6283164445159* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, 'Lo Ngentod? babi looo' ,MessageType.text);
}
else if (text == 'Anjing'){
  ...
  var teks = text.replace(/#nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Proccess...❗', MessageType.text)
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *💔 R E V 💔* , Follow Instagram Mimin Yah😻 : https://instagram.com/revolt_144_' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *💔 R E V 💔* , Follow Instagram Mimin Yah😻 : https://instagram.com/revolt_144_' ,MessageType.text);
}
